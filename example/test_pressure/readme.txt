...
DESKTOP-4VTHOQC# wrk -d30s -t4 -c1000 --latency http://localhost:12000/
Running 30s test @ http://localhost:12000/
  4 threads and 1000 connections
  Thread Stats   Avg      Stdev     Max   +/- Stdev
...
DESKTOP-4VTHOQC# wrk -d30s -t12 -c1000 --latency http://localhost:12000/
Running 30s test @ http://localhost:12000/
...
DESKTOP-4VTHOQC# wrk -d30s -t4 -c2500 --latency http://localhost:12000/
Running 30s test @ http://localhost:12000/
  4 threads and 2500 connections
  Thread Stats   Avg      Stdev     Max   +/- Stdev
...
DESKTOP-4VTHOQC# wrk -d30s -t12 -c2500 --latency http://localhost:12000/
Running 30s test @ http://localhost:12000/
...
DESKTOP-4VTHOQC# wrk -d30s -t4 -c5000 --latency http://localhost:12000/
Running 30s test @ http://localhost:12000/
  4 threads and 5000 connections
  Thread Stats   Avg      Stdev     Max   +/- Stdev
...
DESKTOP-4VTHOQC# wrk -d30s -t12 -c5000 --latency http://localhost:12000/
Running 30s test @ http://localhost:12000/
...
DESKTOP-4VTHOQC# wrk -d30s -t4 -c10000 --latency http://localhost:12000/
Running 30s test @ http://localhost:12000/
...
DESKTOP-4VTHOQC# wrk -d30s -t12 -c10000 --latency http://localhost:12000/
Running 30s test @ http://localhost:12000/
