...
#ifndef OLD_LIBFM_INCLUDE_LIBFM_FMNET_HTTP_HTTPREQUEST_H_
#define OLD_LIBFM_INCLUDE_LIBFM_FMNET_HTTP_HTTPREQUEST_H_
...
#endif //OLD_LIBFM_INCLUDE_LIBFM_FMNET_HTTP_HTTPREQUEST_H_
